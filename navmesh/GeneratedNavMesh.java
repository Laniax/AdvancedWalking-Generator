 ...
 * @author Laniax
 */
public class GeneratedNavMesh implements Serializable {

    private transient LogProxy log = new LogProxy("GeneratedNavMesh");

    private final Set<AbstractShape> shapes;
     ...
     * @param shapes
     */
    public GeneratedNavMesh(Set<AbstractShape> shapes) {
        this.shapes = shapes;
    }
